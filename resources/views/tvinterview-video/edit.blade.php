            ...
            <div class="col-md-12 m-auto">
                <div class="card  rounded-card-10px">
                    <div class="card-header">
                        <h5> {{ __('Edit Tv-interview') }}</h5>
                        {{-- {{($user->title)}} --}}
                    </div>
                    {{ Form::model($user, ['route' => ['tvinterview-video.update', $user->id], 'method' => 'PUT','enctype' => 'multipart/form-data','id'=> 'editTvInterviewForm']) }}
                    <div class="card-body">
                        <div class="row">
                    ...
                    <div class="card-footer" style="padding: 10px 0px !important;">
                        <div class="d-flex align-items-center justify-content-end px-4 py-1 gap-2">
                            <a href="{{ route('tvinterview-video.index') }}" class="btn btn-secondary mb-0">{{ __('Cancel') }}</a>
...
@push('scripts')
  ...
  function validateform() {
    ...
    const formElement = document.getElementById('editTvInterviewForm');
