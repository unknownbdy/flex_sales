...
<table id="showBooksIn" class="table table-bordered">
    <thead>
        ...
        <tr>
            <th>Topic Arabic </th>
            <td>{{$row['topic_arabic']}}</td>
        </tr>
        <tr>
            <th>Channel English</th>
            <td>{{$row['channel_english']}}</td>
        </tr>
        <tr>
    ...
    <tr>
            ...
            <div class="card-footer" style="padding: 10px 0px !important;">
                    ...
                    <a class="btn btn-primary" href="{{ route('tvinterview-video.index') }}"> Back</a>
                    </div>
                </div>
        </div></div></div></div>
