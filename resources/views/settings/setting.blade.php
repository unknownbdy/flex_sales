    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-xl-9">
                    {{--  --}}
                    <div id="useradd-1" class="card rounded-card-10px">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="bg-light text-center">
                                                {!! form::image($logo . 'dark_logo.png', null, ['class' => 'img-responsive my-2 text-center logo_img', 'style' => 'width: 50%']) !!}
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="bg-dark text-center">
                                                {!! form::image($logo . '/light_logo.png', null, ['class' => 'logo_img img-responsive my-2 text-center text-white']) !!}
                                            </div>
                    ...
                    {{--  --}}
                    <div id="useradd-2" class="card rounded-card-10px">
                    ...
                    <div id="useradd-3" class="card rounded-card-10px">
                        <div class="card-header">
