                    ...
                    <div class="col-md-12 m-auto">
                        <div class="card  rounded-card-10px">
                            <div class="card-header">
                                <h5> {{ __('Create Tv-Show') }}</h5>
                            </div>
                            {!! Form::open(['route' => 'tvshow-video.store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'createTVShowForm']) !!}
                            <div class="card-body">
                            <div class="row">
...
<script>
  function validateform() {
    ...
    const formElement = document.getElementById('createTVShowForm');
