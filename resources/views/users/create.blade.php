                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::date('date', null, ['placeholder' => __('date'), 'class' => 'form-control']) !!}
                                </div>
                                <div class="form-group">
                                    {{ Form::label('name', __('date'),['class' => 'col-form-label']) }}
                                    {!! Form::time('name', null, ['placeholder' => __('date'), 'class' => 'form-control']) !!}
                                </div>
                                <div class="form-group">
                                    {{ Form::label('name', __('date'),['class' => 'col-form-label']) }}
                                    {!! Form::file('name', null, ['placeholder' => __('date'), 'class' => 'form-control']) !!}
                                </div>
