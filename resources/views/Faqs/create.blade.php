        ...
        <div class="col-md-12 m-auto">
            <div class="card  rounded-card-10px">
                <div class="card-header">
                    <h5> {{ __('Create FAQs') }}</h5>
                </div>
                    {!! Form::open(['route' => 'faqs.store', 'method' => 'POST','id'=>'createfaqsForm']) !!}
                    <div class="card-body">
                    <div class="row">
...
<script>
    ...
    const formElement = document.getElementById('createfaqsForm');
