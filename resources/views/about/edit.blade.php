    ...
    <div class="section-body">
        <div class="col-md-12 m-auto">
            <div class="card rounded-card-10px">
                ...
                {{ Form::model($about, ['route' => ['about.update', $about->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data','id'=>'editAboutForm']) }}
                <div class="card-body">
                    ...
                    <div class="form-group col-8">
                            <div class="choose-file d-flex align-items-center">
                                <div for="avatar" style="width: 50%">
                                    <label class="col-form-label">{{ __('Choose images here') }}</label>
                                    <input type="file" class="form-control" name="images[]" id="thumbnail"
                                ...
                                <p class="thumbnail ms-4 mb-0">
                                    ...
                                    <img src="{{ asset($about->thumbnail) }}" alt="Thumbnail" width="70" height="70"
                ...
                <div class="card-footer" style="padding: 10px 0px !important">
                    <div class="d-flex align-items-center justify-content-end px-4 py-1 gap-2">
                        <a href="{{ route('about.index') }}" class="btn btn-secondary mb-0">{{ __('Cancel') }}</a>
...
<script>
    ...
    const formElement = document.getElementById('editAboutForm');
