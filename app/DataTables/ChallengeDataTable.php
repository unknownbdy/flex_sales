...
class ChallengeDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('created_at', function (Challenge $Challenge) {
                return  UtilityFacades::dateFormat($Challenge->created_at);
            })
            ->addColumn('action', function (Challenge $Challenge) {
                return view('Challenge.action', compact('Challenge'));
            });
    }
    ...
    {
        return 'Chanllenge_Videos_' . date('YmdHis');
    }
}
