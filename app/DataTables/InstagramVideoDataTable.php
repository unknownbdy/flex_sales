...
class InstagramVideoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('created_at', function (InstagramVideo $instagramVideo) {
                return  UtilityFacades::dateFormat($instagramVideo->created_at);
            })
            ->addColumn('action', function (InstagramVideo $instagramVideo) {
                return view('instagram-video.action', compact('instagramVideo'));
            });
    }

    public function query(InstagramVideo $model)
    {
    ...
    {
        return 'Instagram_Videos_' . date('YmdHis');
    }
}
