...
class CoursesVideoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('created_at', function (Course $coursesVideo) {
                return  UtilityFacades::dateFormat($coursesVideo->created_at);
            })
            ->addColumn('action', function (Course $coursesVideo) {
                return view('Course-video.action', compact('coursesVideo'));
            });
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('course_name_arabic'),
    ...
    {
        return 'Course_Videos_' . date('YmdHis');
    }
}
