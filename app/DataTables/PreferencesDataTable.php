...
class PreferencesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('created_at', function (Preference $preference) {
                return  UtilityFacades::dateFormat($preference->created_at);
            })
            ->addColumn('action', function (Preference $preference) {
                return view('preferences.action', compact('preference'));
            });
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('id'),
            Column::make('preferences_name'),
            Column::make('arbic_preferences_name'),
    ...
    {
        return 'Preferences_' . date('YmdHis');
    }
}
