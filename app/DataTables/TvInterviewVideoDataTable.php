...
class TvInterviewVideoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('created_at', function (TvInterview $podcastVideo) {
                return  UtilityFacades::dateFormat($podcastVideo->created_at);
            })
            ->addColumn('action', function (TvInterview $podcastVideo) {
                return view('tvinterview-video.action', compact('podcastVideo'));
            });
    }

    public function query(TvInterview $model)
    {
    ...
    {
        return 'Tvinterview_Videos_' . date('YmdHis');
    }
}
